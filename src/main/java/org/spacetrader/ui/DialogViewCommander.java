...
public class DialogViewCommander extends Dialog {
    ...
    public DialogViewCommander() {
        final Label labelNameLabel = new Label();
        final Label labelName = new Label();
        final Label labelDifficulty = new Label();
        final Button buttonClose = new Button();
        final Label labelTimeLabel = new Label();
        final Label labelCashLabel = new Label();
        final Label labelDebtLabel = new Label();
        final Label labelNetWorthLabel = new Label();
        final Label labelDifficultyLabel = new Label();
        final Label labelTime = new Label();
        final GroupBox boxSkills = new GroupBox();
        final Label labelEngineer = new Label();
        final Label labelTrader = new Label();
        final Label labelFighter = new Label();
        final Label labelPilot = new Label();
        final Label labelEngineerLabel = new Label();
        final Label labelTraderLabel = new Label();
        final Label labelFighterLabel = new Label();
        final Label labelPilotLabel = new Label();
        final GroupBox boxFinances = new GroupBox();
        final Label labelCash = new Label();
        final Label labelDebt = new Label();
        final Label labelNetWorth = new Label();
        final GroupBox boxNotoriety = new GroupBox();
        final Label labelPoliceLabel = new Label();
        final Label labelReputationLabel = new Label();
        final Label labelKillsLabel = new Label();
        final Label labelKills = new Label();
        final Label labelReputation = new Label();
        final Label labelRecord = new Label();
        final Label labelBountyLabel = new Label();
        final Label labelBounty = new Label();
        ...
        final int score = commander.getPoliceRecordScore();
