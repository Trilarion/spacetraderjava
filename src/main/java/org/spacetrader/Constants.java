...
public enum Constants {
    ...
    public static final String CustomDirectory = Utils.combine(Constants.BaseDirectory, "custom");
    public static final String CustomImagesDirectory = Utils.combine(Constants.CustomDirectory, "images");
    public static final String CustomTemplatesDirectory = Utils.combine(Constants.CustomDirectory, "templates");
    public static final String DataDirectory = Utils.combine(Constants.BaseDirectory, "data");
    public static final String HighScoreFile = Utils.combine(Constants.DataDirectory, "HighScores.bin");
    public static final String DefaultSettingsFile = Utils.combine(Constants.DataDirectory, "DefaultSettings.bin");
    public static final String SaveDirectory = Utils.combine(Constants.BaseDirectory, "save");
    ...
    public static final PoliceRecord[] PoliceRecords = {
            new PoliceRecord(PoliceRecordType.Psychopath, Constants.PoliceRecordScorePsychopath),
            new PoliceRecord(PoliceRecordType.Villain, Constants.PoliceRecordScoreVillain),
            new PoliceRecord(PoliceRecordType.Criminal, Constants.PoliceRecordScoreCriminal),
            new PoliceRecord(PoliceRecordType.Crook, Constants.PoliceRecordScoreCrook),
            new PoliceRecord(PoliceRecordType.Dubious, Constants.PoliceRecordScoreDubious),
            new PoliceRecord(PoliceRecordType.Clean, Constants.PoliceRecordScoreClean),
            new PoliceRecord(PoliceRecordType.Lawful, Constants.PoliceRecordScoreLawful),
            new PoliceRecord(PoliceRecordType.Trusted, Constants.PoliceRecordScoreTrusted),
            new PoliceRecord(PoliceRecordType.Liked, Constants.PoliceRecordScoreLiked),
            new PoliceRecord(PoliceRecordType.Hero, Constants.PoliceRecordScoreHero)
    };
    ...
    public static final Reputation[] Reputations = {
            new Reputation(ReputationType.Harmless, Constants.ReputationScoreHarmless),
            new Reputation(ReputationType.MostlyHarmless, Constants.ReputationScoreMostlyHarmless),
            new Reputation(ReputationType.Poor, Constants.ReputationScorePoor),
            new Reputation(ReputationType.Average, Constants.ReputationScoreAverage),
            new Reputation(ReputationType.AboveAverage, Constants.ReputationScoreAboveAverage),
            new Reputation(ReputationType.Competent, Constants.ReputationScoreCompetent),
            new Reputation(ReputationType.Dangerous, Constants.ReputationScoreDangerous),
            new Reputation(ReputationType.Deadly, Constants.ReputationScoreDeadly),
            new Reputation(ReputationType.Elite, Constants.ReputationScoreElite)
    };
    ...
    public static final Equipment[] EquipmentForSale = {
            Constants.WeaponObjects[WeaponType.PulseLaser.id],
            Constants.WeaponObjects[WeaponType.BeamLaser.id],
            Constants.WeaponObjects[WeaponType.MilitaryLaser.id],
            Constants.WeaponObjects[WeaponType.PhotonDisruptor.id],
            Constants.Shields[ShieldType.Energy.id],
            Constants.Shields[ShieldType.Reflective.id],
            Constants.Gadgets[GadgetType.ExtraCargoBays.asInteger()],
            Constants.Gadgets[GadgetType.AutoRepairSystem.asInteger()],
            Constants.Gadgets[GadgetType.NavigatingSystem.asInteger()],
